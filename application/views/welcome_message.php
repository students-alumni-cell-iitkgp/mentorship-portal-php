...
<body>
	...
	<div id="bg">
		...
		<div class="row" id="box" style="width:100%;float:right;margin-top:0px">
			...
			echo form_open('http://www.mentorship.iitkgp.ernet.in/index.php/welcome/member_area',$for);
			?>
			<div class="col-md-3">
				<?php
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				$a = array('class'=>'form-horizontal',
					'method'=>'post',
					'role'=>'form');
				echo form_open('http://www.mentorship.iitkgp.ernet.in/index.php/welcome/users',$a);					
				?>
